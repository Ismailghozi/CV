...
<body>
    <section>
        ...
        <nav>
            <!--- logo --->
            <img src ="../rumah_sakit/foto/rumahsakit.png" class="logo">Portfolio Tutorial</a>
            <!--- menu --->
            <ul>
                <li><a href="dashboard.php" class="active">Home</a></li>
                <li><a href="#">Services</a></li>
                <li><a href="#">Testimonials</a></li>
                <li><a href="../joki_games/kontak.php/">Contact</a></li>
            </ul>
        </nav>
        ...
        <div class="text-container">
            <p>Hello,</p>
            <p>I&#8217;SELAMAT DATANG DI JOKI GAMES BANG BANG</p>
            <p>SEO Technical Writer & Developer</p>
            <p>An aquarius girl who loves music, watching movies and
            <br>of course writing.</p>
          <a href="../penjoki/tambah.php">  <button class="hire-btn">Sign Up</button></a>
            <button class="down-cv">Sign in</button>
        </div>
        <!-- model -->
